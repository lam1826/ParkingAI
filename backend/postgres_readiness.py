...
# Approved simplified workflows and camera passages, revisions 20260923_08/09.
REQUIRED_TABLES |= frozenset(['declared_parking_reservations',
 'session_payment_access',
 'session_ticket_credentials',
 'vision_automation_policies',
 'vision_passage_events'])
REQUIRED_COLUMN_CONTRACTS |= frozenset(['declared_parking_reservations.arrival_deadline:timestamp without time zone::NO',
 'declared_parking_reservations.created_at:timestamp without time zone::NO',
 'declared_parking_reservations.end_at:timestamp without time zone::NO',
 'declared_parking_reservations.id:character varying:36:NO',
 'declared_parking_reservations.license_plate:character varying:20:NO',
 'declared_parking_reservations.normalized_plate:character varying:20:NO',
 'declared_parking_reservations.request_id:character varying:64:NO',
 'declared_parking_reservations.session_id:character varying:36:YES',
 'declared_parking_reservations.site_id:integer::NO',
 'declared_parking_reservations.slot_id:integer::NO',
 'declared_parking_reservations.start_at:timestamp without time zone::NO',
 'declared_parking_reservations.status:character varying:12:NO',
 'declared_parking_reservations.user_id:integer::NO',
 'declared_parking_reservations.vehicle_type_id:integer::NO',
 'session_payment_access.created_at:timestamp without time zone::NO',
 'session_payment_access.credential_version:character varying:32:NO',
 'session_payment_access.customer_snapshot_id:integer::YES',
 'session_payment_access.expires_at:timestamp without time zone::NO',
 'session_payment_access.id:character varying:36:NO',
 'session_payment_access.revoked_at:timestamp without time zone::YES',
 'session_payment_access.session_id:character varying:36:NO',
 'session_payment_access.user_id:integer::NO',
 'session_payment_access.vehicle_id:integer::NO',
 'session_ticket_credentials.created_at:timestamp without time zone::NO',
 'session_ticket_credentials.revoked_at:timestamp without time zone::YES',
 'session_ticket_credentials.session_id:character varying:36:NO',
 'session_ticket_credentials.version:character varying:32:NO',
 'vehicle_types.code_prefix:character varying:8:YES',
 'vehicle_types.requires_plate:boolean::NO',
 'vision_automation_policies.camera_id:integer::NO',
 'vision_automation_policies.direction:character varying:8:NO',
 'vision_automation_policies.enabled:boolean::NO',
 'vision_automation_policies.enabled_at:timestamp without time zone::YES',
 'vision_automation_policies.max_age_seconds:integer::NO',
 'vision_automation_policies.minimum_confidence:double precision::NO',
 'vision_automation_policies.updated_at:timestamp without time zone::NO',
 'vision_automation_policies.updated_by_id:integer::NO',
 'vision_automation_policies.zone_id:integer::YES',
 'vision_observations.capture_source:character varying:16:NO',
 'vision_passage_events.actor_id:integer::NO',
 'vision_passage_events.camera_id:integer::NO',
 'vision_passage_events.captured_at:timestamp without time zone::NO',
 'vision_passage_events.direction:character varying:8:NO',
 'vision_passage_events.event_id:character varying:36:NO',
 'vision_passage_events.id:character varying:36:NO',
 'vision_passage_events.license_plate:character varying:20:YES',
 'vision_passage_events.observation_id:character varying:36:YES',
 'vision_passage_events.observation_key:character varying:36:NO',
 'vision_passage_events.plate_key:character varying:20:YES',
 'vision_passage_events.processed_at:timestamp without time zone::NO',
 'vision_passage_events.reason:character varying:500:NO',
 'vision_passage_events.session_id:character varying:36:YES',
 'vision_passage_events.site_id:integer::NO',
 'vision_passage_events.state:character varying:20:NO',
 'vision_passage_events.vehicle_type_id:integer::YES'])
REQUIRED_INDEXES |= frozenset(['ix_declared_booking_plate_interval',
 'ix_declared_booking_slot_interval',
 'ix_declared_parking_reservations_site_id',
 'ix_declared_parking_reservations_user_id',
 'ix_session_payment_access_session_id',
 'ix_session_payment_access_user_id',
 'ix_vision_passage_plate_time',
 'ix_vision_passage_site_time',
 'uq_vehicle_types_code_prefix'])
REQUIRED_CONSTRAINTS |= frozenset(['ck_declared_booking_interval',
 'ck_declared_booking_status',
 'ck_session_payment_access_expiry',
 'ck_vision_auto_age',
 'ck_vision_auto_confidence',
 'ck_vision_auto_direction',
 'ck_vision_passage_direction',
 'ck_vision_passage_state',
 'uq_declared_booking_request',
 'uq_session_payment_access_user_session',
 'uq_vision_passage_camera_event',
 'uq_vision_passage_observation'])
REQUIRED_TRIGGERS |= frozenset(['trg_declared_blocks_guaranteed_allocations',
 'trg_declared_blocks_parking_capacity_holds',
 'trg_declared_blocks_parking_reservations',
 'trg_declared_booking_delete',
 'trg_declared_booking_frozen',
 'trg_declared_booking_replace',
 'trg_declared_booking_source',
 'trg_declared_catalog_parking_slots',
 'trg_declared_catalog_vehicle_types',
 'trg_declared_catalog_zones',
 'trg_declared_session_activate',
 'trg_declared_session_cancel',
 'trg_declared_session_insert',
 'trg_ticket_access_delete',
 'trg_ticket_access_source',
 'trg_ticket_access_update',
 'trg_ticket_owner_changed',
