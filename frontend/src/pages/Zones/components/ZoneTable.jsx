...
const ZoneTable = ({ data, loading, onAdd, onEdit, onDelete }) => {
  ...
  const columns = [
    ...
    { field: "name", headerName: "Tên khu vực", flex: 1.5, minWidth: 180 },
    { field: "capacity", headerName: "Sức chứa", width: 120, type: "number" },
    {
      field: "is_active",
