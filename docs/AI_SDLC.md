...
Theo phản hồi tiếp theo “Bật tự động bị mờ”, đã tái hiện điều kiện khóa nhầm Admin/Manager, sửa khởi động camera → xác nhận quyền máy chủ → quét ảnh mới, và bổ sung kiểm tra lỗi/quyền cùng vòng đời ảnh tự động. [Biên bản sửa tự động](CAMERA_AUTOMATION_FIX_2026-09-24.md) ghi code, test trước/sau và giới hạn nhận diện; không dùng kết quả luồng UI để công bố độ chính xác OCR.

Vòng debug/kiểm thử thật ngày24/09 được lưu tại [COMPREHENSIVE_RETEST_2026-09-24.md](COMPREHENSIVE_RETEST_2026-09-24.md): tái hiện camera có hình nhưng không gửi OCR, lỗi CSS nút hồ sơ, ranh giới thời điểm xe đặt trước vào bãi và thông báo trùng mã loại xe; giữ bằng chứng lỗi trước sửa và test sau sửa. [Kiểm Gemini thật mới](AI_LIVE_RETEST_2026-09-24.md) có đủ ngày/tuần/hỏi đáp/nhân sự/kỳ rỗng/Customer đã đọc và đối chiếu, đồng thời giữ ba lỗi503. [Đánh giá OCR mới](CAMERA_SCAN_DIAGNOSIS_2026-09-24.md) giữ cả436/500 crop không đúng qua toàn pipeline; không dùng kết quả OCR riêng thay cho độ chính xác hệ thống. Đây là bằng chứng tác vụ đã làm, không phải lịch sử prompt dựng lại.

Vòng **triển khai demo đã được người dùng duyệt** ngày23/09 được ghi tại [DEMO_IMPLEMENTATION_2026-09-23.md](DEMO_IMPLEMENTATION_2026-09-23.md): thiết kế quyền thanh toán theo vé và đặt trước không cấp sở hữu (KT1), mã React/FastAPI và kiểm tra phí/capacity/concurrency (KT2), chatbot theo quyền và test chặn mã bí mật trước provider (KT3). Các test AI dùng mock được ghi riêng; lần gọi thật hiện503, chưa có kết quả mới để đánh giá nội dung.

Cập nhật 23/09/2026: [biên bản ưu tiên đề gốc](CORE_ACCEPTANCE_2026-09-23.md) bổ sung vòng sửa chỗ trống, test/API/UI mới và ma trận F01–F13. AI tự động dùng provider giả đạt; kiểm Gemini thật hiện trả 503 UNAVAILABLE, chưa có output mới để đánh giá nội dung. Các kết quả live bên dưới là lịch sử, không thay cho lần kiểm mới.
