...
Phạm vi hiện tại: **một bãi để nộp đồ án**, FastAPI/React modular monolith, trình diễn trên website hiện tại. Giao diện dùng bãi DEMO A (ID2), ẩn đổi/tạo bãi. QR mô phỏng, không chuyển tiền; Gemini đã bật và nghiệm thu ba nhóm phân tích ở bản `0b8c54c`. Quản lý/nhân viên có Báo cáo/AI và tra cứu ngày: [hướng dẫn](CORE_AI_COMPLETION.md). Lịch sử seed có nhãn `demo://synthetic-history/<namespace>`, phí bằng 0 và không sinh khoản thu thật.
